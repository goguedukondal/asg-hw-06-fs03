  ...
  return (
    <div className="header_part">
      <div className="left">
        ...
        <div style={{backgroundColor:"#F7C04A",width:"30px",height:"30px",borderRadius:"50%",marginTop:"40px"}}></div>
        <div style={{backgroundColor:"#EB455F",width:"40px",height:"40px",borderRadius:"50%",marginTop:"10px"}}></div>
        <div style={{backgroundColor:"#6C9BCF",width:"40px",height:"40px",borderRadius:"50%",marginTop:"40px"}}></div>
        </div>
